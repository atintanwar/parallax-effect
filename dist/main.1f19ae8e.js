...
var initValue = getbounds(mainElement).y;
var scroll$ = (0, _rxjs.fromEvent)(window, 'scroll').pipe((0, _operators.map)(function () {
  return getbounds(mainElement);
}));
var animationFrame$ = (0, _rxjs.of)(0, _rxjs.animationFrameScheduler).pipe((0, _operators.repeat)());
var moveOnScrolls$ = animationFrame$.pipe((0, _operators.withLatestFrom)(scroll$), (0, _operators.pluck)(1, 'y'));
var interpolatedStream$ = moveOnScrolls$.pipe((0, _operators.startWith)(initValue), (0, _operators.scan)(lerp));
interpolatedStream$.subscribe(function (posY) {
  var y = 400 - posY;
  image.style.cssText = "\n          transform: translate(".concat(0, "px,", -y, "px);\n        ");
});
